    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-white to-blue-50">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="space-y-8">
          {/* Badge */}
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-white/40 backdrop-blur-md border border-white/20 shadow-lg">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8">
            <Link
              to="/shop"
              className="group relative px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-2xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
            >
            ...
            <button className="px-8 py-4 bg-white/40 backdrop-blur-md border border-white/20 text-gray-700 rounded-2xl font-semibold shadow-lg hover:shadow-xl hover:bg-white/60 transition-all duration-300 transform hover:scale-105">
              Watch Demo
            </button>
          </div>
